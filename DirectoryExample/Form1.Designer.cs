namespace DirectoryExample
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.button1.Click += new System.EventHandler(this.Create_Clicked);
			// 
			// button2
			// 
			...
			this.button2.Click += new System.EventHandler(this.Move_Clicked);
			// 
			// button3
			// 
			...
			this.button3.Click += new System.EventHandler(this.Delete_Clicked);
			// 
			// button4
			// 
